...
public class StreamsTest {
    ...
    public void testFindWeaponWithLowestDamage() {
        ...
        Streams instance = new Streams();
        Weapons expResult = weapons.get(3);
        Weapons result = instance.findWeaponWithLowestDamage(weapons);
        assertEquals(expResult, result);
    }
    ...
    public void testFindWeaponWithHighestStrength() {
        ...
        Streams instance = new Streams();
        Weapons expResult = weapons.get(2);
        Weapons result = instance.findWeaponWithHighestStrength(weapons);
        assertEquals(expResult, result);
    }
    ...
    public void testCollectMissileWeapons() {
        ...
        Streams instance = new Streams();
        List<Weapons> expResult = new LinkedList<>();
        expResult.add(weapons.get(1));
        expResult.add(weapons.get(8));
        expResult.add(weapons.get(9));
        List<Weapons> result = instance.collectMissileWeapons(weapons);
        assertEquals(expResult, result);
    }
    ...
    public void testFindWeaponWithLongestName() {
        ...
        Streams instance = new Streams();
        Weapons expResult = weapons.get(11);
        Weapons result = instance.findWeaponWithLongestName(weapons);
        assertEquals(expResult, result);
    }
    ...
    public void testRemoveDuplicates() {
        ...
        Streams instance = new Streams();
        List<Weapons> expResult = weapons;
        expResult.remove(expResult.size() - 1);
        expResult.remove(expResult.size() - 1);
        List<Weapons> result = instance.removeDuplicates(weapons);
        assertEquals(expResult, result);
    }
    ...
    private List<Weapons> readFile(String file) throws IOException {
    ...
    public void test02() throws Throwable {
        Streams streams0 = new Streams();
        LinkedList<Weapons> linkedList0 = new LinkedList<Weapons>();
        CombatType combatType0 = CombatType.MELEE;
        DamageType damageType0 = DamageType.PIERCING;
        Weapons weapon0 = new Weapons("k:|8,hxR", combatType0, damageType0, 5060, 5060, 5060, 5);
    ...
    public void test05() throws Throwable {
        ...
        Weapons weapon0 = new Weapons("", combatType0, damageType0, 1, 1, 0, (-4052));
        linkedList0.add(weapon0);
        int int0 = streams0.sumUpValues(linkedList0);
    ...
    public void test06() throws Throwable {
        ...
        Weapons weapon0 = new Weapons("%\"]N)f5", combatType0, damageType0, (-1), (-1), (-1), 1155);
        linkedList0.add(weapon0);
    ...
    public void test07() throws Throwable {
        ...
        DamageType damageType0 = DamageType.MISSILE;
        Weapons weapon0 = new Weapons("net.htlgrieskirchen.pos3.streams.CombatType", combatType0, damageType0, 0, (-252), (-252), (-1));
    ...
    public void test08() throws Throwable {
        ...
        Weapons weapon0 = new Weapons("k:|8,hxR", combatType0, damageType0, 5060, 5060, 5060, 5);
        linkedList0.add(weapon0);
        List<Weapons> list0 = streams0.removeDuplicates(linkedList0);
    ...
    public void test09() throws Throwable {
        ...
        CombatType combatType0 = CombatType.MELEE;
        DamageType damageType0 = DamageType.MISSILE;
        Weapons weapon0 = new Weapons("SUF4x}5T9QGT#L~", combatType0, damageType0, (-2151), (-2151), (-2151), 0);
        weapon0.setValue((-2891));
        linkedList0.offerFirst(weapon0);
        Weapons weapon1 = streams0.findWeaponWithLowestDamage(linkedList0);
    ...
    public void test10() throws Throwable {
        ...
        Weapons weapon0 = new Weapons("", combatType0, damageType0, 0, 4, 0, 0);
        linkedList0.add(weapon0);
        Weapons weapon1 = streams0.findWeaponWithLowestDamage(linkedList0);
    ...
    public void test11() throws Throwable {
        ...
        CombatType combatType0 = CombatType.MELEE;
        DamageType damageType0 = DamageType.NONE;
        Weapons weapon0 = new Weapons((String) null, combatType0, damageType0, 0, 0, 0, 0);
    ...
    public void test12() throws Throwable {
        ...
        DamageType damageType0 = DamageType.NONE;
        Weapons weapon0 = new Weapons("9", combatType0, damageType0, 451, 0, 451, 2237);
        linkedList0.add(weapon0);
        Weapons weapon1 = streams0.findWeaponWithLowestDamage(linkedList0);
    ...
    public void test13() throws Throwable {
        ...
        CombatType combatType0 = CombatType.MELEE;
        DamageType damageType0 = DamageType.NONE;
        Weapons weapon0 = new Weapons("", combatType0, damageType0, 1552, 0, 1552, 0);
        linkedList0.add(weapon0);
        Weapons weapon1 = streams0.findWeaponWithLongestName(linkedList0);
        assertEquals(1552, weapon1.getStrength());
    }
    ...
    public void test14() throws Throwable {
        ...
        CombatType combatType0 = CombatType.MELEE;
        DamageType damageType0 = DamageType.SLASHING;
        Weapons weapon0 = new Weapons(",rGJ>c]?,i", combatType0, damageType0, 0, (-1), 0, (-1743));
        linkedList0.add(weapon0);
        Weapons weapon1 = streams0.findWeaponWithLongestName(linkedList0);
        assertEquals(CombatType.MELEE, weapon1.getCombatType());
    }
    ...
    public void test15() throws Throwable {
        ...
        CombatType combatType0 = CombatType.MELEE;
        DamageType damageType0 = DamageType.MISSILE;
        Weapons weapon0 = new Weapons("", combatType0, damageType0, 0, 0, (-1), 439);
        linkedList0.add(weapon0);
        Weapons weapon1 = streams0.findWeaponWithLongestName(linkedList0);
    ...
    public void test17() throws Throwable {
        ...
        CombatType combatType0 = CombatType.NONE;
        DamageType damageType0 = DamageType.PIERCING;
        Weapons weapon0 = new Weapons((String) null, combatType0, damageType0, (-1116), 1, 1, (-1116));
        linkedList0.add(weapon0);
        Weapons weapon1 = streams0.findWeaponWithLongestName(linkedList0);
        assertEquals(1, weapon1.getStrength());
    }
    ...
    public void test18() throws Throwable {
        ...
        Weapons weapon0 = new Weapons("net.htlgrieskirchen.pos3.streams.CombatType", combatType0, damageType0, 0, (-252), (-252), (-1));
        linkedList0.add(0, weapon0);
        Weapons weapon1 = streams0.findWeaponWithHighestStrength(linkedList0);
    ...
    public void test19() throws Throwable {
        ...
        Weapons weapon0 = new Weapons("", combatType0, damageType0, 1193, 1193, 1193, 1);
        linkedList0.add(weapon0);
        Weapons weapon1 = streams0.findWeaponWithHighestStrength(linkedList0);
    ...
    public void test20() throws Throwable {
        ...
        CombatType combatType0 = CombatType.NONE;
        DamageType damageType0 = DamageType.BLUNT;
        Weapons weapon0 = new Weapons((String) null, combatType0, damageType0, (-1), 0, 0, 0);
        linkedList0.add(weapon0);
        Weapons weapon1 = streams0.findWeaponWithHighestStrength(linkedList0);
    ...
    public void test21() throws Throwable {
        ...
        Weapons weapon0 = new Weapons("net.htlgrieskirchen.pos3.streams.CombatType", combatType0, damageType0, 0, (-252), (-252), (-1));
        linkedList0.add(0, weapon0);
        List<Weapons> list0 = streams0.collectMissileWeapons(linkedList0);
        assertTrue(list0.contains(weapon0));
    }
    ...
    public void test45() throws Throwable {
        Streams streams0 = new Streams();
        LinkedList<Weapons> linkedList0 = new LinkedList<Weapons>();
        Weapons weapon0 = streams0.findWeaponWithHighestStrength(linkedList0);
        assertNull(weapon0);
    }
    ...
    public void test46() throws Throwable {
        Streams streams0 = new Streams();
        LinkedList<Weapons> linkedList0 = new LinkedList<Weapons>();
        Weapons weapon0 = streams0.findWeaponWithLongestName(linkedList0);
        assertNull(weapon0);
    }
    ...
    public void test48() throws Throwable {
        Streams streams0 = new Streams();
        LinkedList<Weapons> linkedList0 = new LinkedList<Weapons>();
        Weapons weapon0 = streams0.findWeaponWithLowestDamage(linkedList0);
        assertNull(weapon0);
    }
